<template>
    <div>
        <div class="relative w-full" v-if="current_task.scripts[props.index]">
            <textarea id="hs-textarea-ex-1"
                ...
                rows="5" placeholder="您的剧本……" v-model="current_task.scripts[props.index]" @blur="modify_script"></textarea>
        </div>
...
const emit = defineEmits(['modify_script'])
