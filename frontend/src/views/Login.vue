                        ...
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-sm text-neutral-600 dark:text-neutral-400">
                                ...
                                <RouterLink to="/register">
                                    <span
                                        class="text-violet-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:outline-1 dark:focus:outline-neutral-600">
                                        现在注册
                                    </span>
                                </RouterLink>
                            </p>
                                ...
                                <div class="grid gap-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            <input type="email" id="email" name="email"
                                                class="py-3 px-4 block w-full border border-neutral-200 rounded-lg text-sm focus:border-violet-500 focus:outline-violet-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:outline-neutral-600"
                                                required aria-describedby="email-error" v-model="login_form.email">
                                            <div
                                    ...
                                    <div>
                                        <div class="flex justify-between items-center">
                                            ...
                                            <!-- <a class="text-sm text-violet-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:outline-1 dark:focus:outline-neutral-600"
                                                href="../examples/html/recover-account.html">Forgot password?</a> -->
                                        </div>
                                        <div class="relative">
                                            <input type="password" id="password" name="password"
                                                class="py-3 px-4 block w-full border border-neutral-200 rounded-lg text-sm focus:border-violet-500 focus:outline-violet-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:outline-neutral-600"
                                                required aria-describedby="password-error" v-model="login_form.password"
...
const login = () => {
    ...
    axios.post('/api/account/login/', login_form).then(res => {
